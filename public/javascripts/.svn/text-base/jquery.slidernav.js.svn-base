...
$.fn.sliderNav = function(options) {
	var defaults = { items: ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"], debug: false, height: null, arrows: true,start_with: null};
	...
	var height = $('.slider-nav', slider).height();
        var start_with = o.items[0];
        if(o.start_with) start_with = o.start_with;
	if(o.height) height = o.height;
	$('.slider-content, .slider-nav, .slider-content-letter', slider).css('height',height);
	...
	$('.slider-nav a', slider).mouseover(function(event){
		...
		var pScroll = tOffset-220;//(tOffset - cOffset) - height/8;
