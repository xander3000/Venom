class ProductByInvoice < ActiveRecord::Base
  attr_accessor :id_temporal

  humanize_attributes  :quantity_page_sheet => "Cant. Pag."



  has_many   :product_component_by_invoices
  has_many :accesory_component_by_invoices
  belongs_to :invoice
  belongs_to :product
